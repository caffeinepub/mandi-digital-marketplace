...
export interface backendInterface {
    ...
    _getProfile(): Promise<UserProfile>;
...
export class Backend implements backendInterface {
    ...
    async _getProfile(): Promise<UserProfile> {
        if (this.processError) {
            try {
                const result = await this.actor._getProfile();
    ...
    async getAllFarmDocuments(): Promise<Array<FarmDocument>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllFarmDocuments();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFarmDocumentCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getFarmDocumentCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Phone]): Phone | null {
...
function from_candid_variant_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "admin" in value ? UserRole.admin : "farm" in value ? UserRole.farm : "seller" in value ? UserRole.seller : "buyer" in value ? UserRole.buyer : value;
}
